INSERT INTO ticket_types (id, ticket_type_code,ticket_type_name,description,includes_workshop)
VALUES (1, 'P','Premium','Access to all conference events plus attend the workshop of your choice.',TRUE),
       (2, 'S','Standard','Access to all conference keynotes,sessions,community open spaces and the exhibition hall',FALSE),
       (3, 'C','Community','Access to keynotes,community open spaces and the exhibition hall',FALSE);

INSERT INTO pricing_categories (id, pricing_category_code,pricing_category_name,pricing_start_date,pricing_end_date)
VALUES (1, 'E','Early Bird','2019-12-01','2020-01-15'),
       (2, 'R','Regular','2020-01-16','2020-03-20'),
       (3, 'L','Last Minute','2020-03-21','2020-04-07');

INSERT INTO ticket_prices (ticket_price_id,ticket_type_id,pricing_id,base_price)
VALUES (1,1,1,800),
       (2,1,2,1000),
       (3,1,3,1200),
       (4,2,1,500),
